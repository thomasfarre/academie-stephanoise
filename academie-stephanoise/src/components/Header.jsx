                    ...
                    <div className="ml-auto w-52 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 xl:order-none">
                      <div className="relative">
                        <img
                          ...
                          alt="Membres de l'Académie Stéphanoise s'entraînant à la boxe"
                    ...
                    <div className="mr-auto w-64 flex-none space-y-8 sm:mr-0 sm:pt-52 xl:pt-36">
                      <div className="relative">
                        <img
                          ...
                          alt="Pratiquants de Krav Maga pendant une session d'entraînement"
                      ...
                      <div className="relative">
                        <img
                          ...
                          alt="Adhérents lors d'un cours de MMA à l'Académie"
                    ...
                    <div className="w-64 flex-none space-y-8 pt-32 sm:pt-0">
                      <div className="relative">
                        <img
                          ...
                          alt="Groupe d'athlètes pendant une séance de Cross Training"
                      ...
                      <div className="relative">
                        <img
                          ...
                          alt="Membres s'entraînant ensemble dans la salle de l'Académie Stéphanoise"
