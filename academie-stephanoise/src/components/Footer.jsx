    ...
    <footer className="bg-neutral-900">
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-72  xl:px-8 xl:pt-96">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-balance text-sm/6 text-neutral-300">
              Il n’y a pas de victoire individuelle dans un lieu où chacun se soutient pour avancer.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div className="mt-10 md:mt-0 space-y-4">
                ...
                <div className="flex items-center text-sm text-neutral-400 pt-4">
                  <EnvelopeIcon className="size-5 mr-4 flex-shrink-0" aria-hidden="true" />
                  <a href="mailto:contact@academiestephanoise.fr" className="hover:text-white">contact@academiestephanoise.fr</a>
                </div>
                <div className="flex items-center text-sm text-neutral-400">
                  <PhoneIcon className="size-5 mr-4 flex-shrink-0" aria-hidden="true" />
                ...
                <div className="flex items-start text-sm text-neutral-400">
                  ...
                  <span>10 Rue de la République, 60200 CHALONS EN CHAMPAGNE</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-sm/6 text-neutral-400">&copy; 2024 Made by Omar all rights reserved.</p>
        </div>
      </div>
    </footer>
  )
