            ...
            <div className="">
              <div className="mt-10 md:mt-0 space-y-4">
                ...
                <div className="flex items-center text-sm text-neutral-400 pt-4">
                  ...
                  <a href="mailto:fclub.contact@gmail.com" className="hover:text-white">fclub.contact@gmail.com</a>
                </div>
                <div className="flex items-center text-sm text-neutral-400">
                  <PhoneIcon className="size-5 mr-4 flex-shrink-0" aria-hidden="true" />
                  <a href="tel:0768702556" className="hover:text-white">07 68 70 25 56</a>
                </div>
